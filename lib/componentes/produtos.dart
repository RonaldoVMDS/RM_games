...
class _ProdutosState extends State<Produtos> {
  var listaProdutos = [
    {
      ...
      "descricao": 'Este jogo, pode ser adquirido para PS4, PS5 e também para computador. Uma bela recomendação para um amante de jogos',
    },
    {
      "nome": 'Elden Ring',
      "foto": ['images/produtos/eldenring/1.png', 'images/produtos/eldenring/2.png', 'images/produtos/eldenring/3.png'],
      "preco": 120,
      "categoria": '',
    ...
    {
      "nome": 'Dying Light 2',
      "foto": ['images/produtos/dyinglight2/1.png', 'images/produtos/dyinglight2/2.png', 'images/produtos/dyinglight2/3.png'],
      "preco": 120,
      "categoria": '',
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder:(context, index) => Produto(
              ...
              footer: Container(
                ...
                child: ListTile(
                  leading: Container(
                    ...
                    child: Text(prodNome, style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white),
                ),
                ),
              title: Container(
                width: 35,
                alignment: Alignment.centerRight,
                child: Text("R\$: $prodPreco", style: const TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 38, 255, 45)))),
            ),
            ), 
            child: Image.asset(prodFoto[0], fit: BoxFit.cover,),
          ),
        ),
      ),
    ));
